...
<div class="max-w-2xl bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
    <form action="{{ route('peminjam.peminjaman.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <select name="alat_id" required class="w-full px-3 py-2 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#E07A5F]">
        ...
        <div class="flex justify-end space-x-2">
            ...
            <button type="submit" class="bg-[#E07A5F] hover:bg-[#D96A4F] text-white px-4 py-2 rounded-xl text-sm font-semibold transition">Ajukan</button>
        </div>
    </form>
</div>
@endsection