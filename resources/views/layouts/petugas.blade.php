    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm hidden md:flex">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            <a href="{{ route('petugas.dashboard') }}" 
               class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 {{ request()->routeIs('petugas.dashboard') ? 'active' : '' }}">
            ...
            class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 {{ request()->routeIs('petugas.laporan') || request()->routeIs('petugas.laporan') ? 'active' : '' }}">
                <i class="fas fa-print w-5 text-center text-lg"></i>
                <span>Laporan</span>
            </a>
        </nav>
        ...
        <div class="p-4 border-t border-gray-100">
            <div class="flex items-center gap-3">
                ...
                <div class="flex-1 min-w-0">
                    <p class="text-sm font-semibold text-gray-800 truncate">{{ auth()->user()->name ?? 'Petugas' }}</p>
