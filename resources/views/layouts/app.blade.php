...
<div class="flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-white border-r border-gray-200 flex flex-col shadow-sm hidden md:flex">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            ...
            class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 {{ request()->routeIs('admin.dashboard') ? 'active' : '' }}">
                <i class="fas fa-th-large w-5 text-center text-lg"></i>
                <span>Dashboard</span>
            </a>

            <a href="{{ route('admin.user.index') }}" 
            class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 {{ request()->routeIs('admin.user.*') ? 'active' : '' }}">
            ...
            class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 {{ request()->routeIs('admin.kategori.*') ? 'active' : '' }}">
                <i class="fas fa-tags w-5 text-center text-lg"></i>
                <span>Kelola Kategori</span>
            </a>

            <a href="{{ route('admin.alat.index') }}" 
            class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 {{ request()->routeIs('admin.alat.*') ? 'active' : '' }}">
                <i class="fas fa-toolbox w-5 text-center text-lg"></i>
                <span>Kelola Alat</span>
            </a>

            <a href="{{ route('admin.peminjaman.index') }}" 
            class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 {{ request()->routeIs('admin.peminjaman.*') ? 'active' : '' }}">
                <i class="fas fa-hand-holding w-5 text-center text-lg"></i>
                <span>Kelola Peminjaman</span>
            </a>

            <a href="{{ route('admin.pengembalian.index') }}" 
            class="sidebar-link flex items-center gap-3 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-600 hover:text-gray-900 hover:bg-gray-50 {{ request()->routeIs('admin.pengembalian.*') ? 'active' : '' }}">
