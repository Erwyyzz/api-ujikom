...
<div class="max-w-2xl bg-white rounded-lg shadow-sm border border-gray-200 p-6">
    <form action="{{ route('admin.alat.update', $alat->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            ...
            <div>
                <label class="block text-gray-700 text-sm font-semibold mb-2">Kondisi</label>
                <select name="kondisi" required class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        ...
        <div class="mb-6">
            ...
            <span class="text-xs text-gray-400 font-normal">(Kosongkan jika tidak ingin mengubah gambar)</span>
            @if($alat->gambar)
                <div class="mb-2">
                   <img src="{{ asset('uploads/alats/' . $alat->gambar) }}" alt="Preview" class="w-16 h-16 object-cover rounded-lg border">
                </div>
            @endif
